...
namespace FunctionApp.RCK.D365.OrderSend
{
    public class FunctionHelper
    {
        ...
        private static void ProcessSalesOrder(RCKSalesOrder salesOrder, SalesOrderParams salesOrderParams, TelemetryClient telemetryClient, EDI_STAGING stage, DateTime startDate, ICloudDb cloudDb, IBlob blob)
        {
            ...
            telemetryClient.TrackTrace(RCKFunctionNames.FUNC_RCK_D365_ORDER_SEND, "Transaction Id: {stage.Transaction_Id}, Pushing EDI Success Message.");
            ...
            telemetryClient.TrackTrace(RCKFunctionNames.FUNC_RCK_D365_ORDER_SEND, "Transaction Id: {stage.Transaction_Id}, Pushed EDI Success Message.");
        }
